...
from quantized_lstm import QuantizedLSTM
...
def create_model(num_inputs, num_hiddens, vocab):
    r'''create base LSTM model'''
...
def main():
    ...
    model_filename = "lstm.pt"
    quantized_model_filename = "lstm_quantized.pt"
    model_filepath = os.path.join(model_dir, model_filename)
    ...
    train_loader, vocab = prepare_dataloader(batch_size, num_steps)
    vocab_size, num_hiddens, device = len(vocab), 256, d2l.try_gpu()
    
    # Create an untrained model.
    model = create_model(vocab_size, num_hiddens, vocab)
    ...
    quantized_model = QuantizedLSTM(model_fp32=fused_model)
